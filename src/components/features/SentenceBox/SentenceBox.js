...
const SentenceBox = ({
  ...
  const checkAndUpdateStats = (currSentence, currInput) => {
    // Work on a copy instead of mutating the state object in place, so React
    // reliably detects the change and accuracy/char stats stay correct.
