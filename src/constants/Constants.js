...
const RESTART_BUTTON_TOOLTIP_TITLE_WORDSCARD =
  "[Tab] + [Enter] to quickly restart the chapter";
...
const HARD_DIFFICULTY_TOOLTIP_TITLE =
  "hard mode generates random words from blog post word data, so you may encounter longer and less frequently used words.";
const NUMBER_ADDON_TOOLTIP_TITLE =
  "number mode generates words that contain random numbers";
const SYMBOL_ADDON_TOOLTIP_TITLE =
  "symbol mode generates words that contain random symbols";
...
const MUSIC_MODE =
  "Spotify player. You will need to log in to Spotify first to use the full feature.";
const FREE_MODE =
