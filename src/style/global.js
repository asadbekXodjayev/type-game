...
export const GlobalStyles = createGlobalStyle`
    /* ---- Design tokens (8px spacing grid, radius, elevation, motion) ---- */
    :root {
        --type-font: 'JetBrains Mono', ui-monospace, 'SFMono-Regular', Menlo, Consolas, monospace;
    ...
    *::before {
    ...
    /* Visible, consistent keyboard focus for accessibility. Mouse clicks
       (:focus without :focus-visible) stay clean. */
    :focus-visible {
        outline: 2px solid ${({ theme }) => theme.stats};
        outline-offset: 2px;
    ...
    /* Reserves vertical space while a lazily-loaded mode chunk is fetched,
       preventing layout collapse/jump on first switch to that mode. */
    .suspense-fallback {
        min-height: 240px;
    }
